...
$lat = '';
$lon = '';
if(count($_POST) > 0 && isset($_POST['maincatid']) && isset($_POST['location'])){
	...
	if(count($catid) > 0 && count($maincatid) > 0){
        ...
        echo "<form action='".SITEURL."editjob2' method='post' id='gotostep2'><input type='hidden' name='jobid' value='".$jobid."'></form><script>document.getElementById('gotostep2').submit();</script>";
		exit;
	}
	/*else{
		echo "<script>location.href='".SITEURL."viewjob/".$jobid."?error=1'</script>";
        exit;
	}*/
...
if(isset($_REQUEST['jobid']) && is_numeric($_REQUEST['jobid'])){
	$myjobid = $_REQUEST['jobid'];
}
...
$myparentcats = dbQuery($dbConn, "SELECT catid from job_parent_cat where jobid = '".trim($myjobid)."'");

while($mycatsrow = dbFetchArray($myparentcats)){
	...
	<div class="works works_success editjoball">
		<div class="container">
            ...
            <div class="login onlyscrol editscrl jobpostnewbgdesn">
                    ...
                    <input type="hidden" value="<?php echo $myjobid;?>" name="jobid">
						<?php
						...
						<div class="form-group">
							...
							<div id="addtime" <?php echo $timeshow;?>>
								<div class="timlt">
                                    ...
                                    <input type="text" placeholder="Start Time" id="starttime" name="starttime" class="form-control timepicker" value="<?php if($starttime!="" && $starttime!="00:00:00") echo $starttime;?>" autocomplete="off">
								...
								<div class="timrt">
									...
									<input type="text" placeholder="End Time" id="endtime" name="endtime" class="form-control timepicker" value="<?php if($endtime!="" && $endtime!="00:00:00") echo $endtime;?>" autocomplete="off">
						...
						<div id="shiftjobdiv" <?php echo $shiftshow;?>>
								...
								<?php
									$staffexp = dbQuery($dbConn, "SELECT starttime,endtime from shift_times where jobid = '".trim($myjobid)."' order by id");
								...
								<?php
										...
										<div class="row">
											...
											<div class="col-sm-2 col-4">
												<label>&nbsp;</label>
													<a href="javascript:void(0);" class="addmyshifttime"><i class="fa fa-plus"></i></a> &nbsp;<a href="javascript:void(0);" class="removemytime"><i class="fa fa-minus"></i></a>
											</div>
										</div>
										<?php
										}
						...
						<div class="row">
							<div class="col-sm-2">
								<input type="button" value="Back" id="backtojob" class="onlybutfulwdt" >
							</div>
							<div class="col-sm-2">
