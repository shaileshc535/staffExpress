										...
										<div class="viewthejobmaindescribe">
											<div class="row">
												...
												<div class="col-sm-3">
													...
													?>
														...
														if($fetch['paytype'] == 4){
															?>
														<h5><?php echo $fetch['annualamt'];?> AUD/Year <span>& Commission <?php echo $fetch['commission_perctg_amt'];?>%</span></h5>
														<?php }
														?>
											...
											<div class="viwmorejobapli">
												...
												<div class="content viethejobbk">
													...
													<button class="rdmrles" onclick="myFunction()" id="myBtn">Read more <i class="fa fa-angle-down" aria-hidden="true"></i></button>
												</div>
											</div>
											<div class="voewjobmeaasgeall">
												...
												<div class="allmeg">
													<?php
													$getcandts = dbQuery($dbConn, "SELECT d.id as msgid,d.msg,d.jobid,b.title,c.id,c.name from job_details b inner join messages d on d.jobid=b.id inner join users c on d.senderid=c.id where (d.receiverid = '".$_SESSION['loginUserId']."') and d.jobid='".$id."' and d.parent_id=0 group by d.senderid order by d.id desc");
													...
													<div class="singlemeg">
														<div class="row">
															<div class="col-sm-1"><div class="clinima"><img src="<?php echo SITEURL;?>images/sercovernoimg.png" alt="" /></div></div>
															<div class="col-sm-7">
																<div class="clndls">
																...
																<div class="rplfrm">
																	...
																	<input type="hidden" id="emp_id" name="employerid" value="<?php echo $_SESSION['loginUserId'];?>">
																		<div class="row">
																			...
																			<div class="col-sm-12">
																				<input type="submit" name="sub" id="sendmsg" value="Reply" style="float:right;">
				...
				<div id="existingmsg" class="onlyscrol"></div>
							...
							<div class="table-responsive successtable">
									<table class="table" cellpadding="5" cellspacing="5">
										...
										$catids = array();
										$staffcatstr = '';
										$jobs = dbQuery($dbConn, "SELECT a.id as userid,a.name,b.hired,b.application_sent_to,c.title,c.id from users a left join job_status b on a.id=b.application_sent_to inner join job_details c on b.jobid=c.id where b.jobid = '".$id."' and b.contacting=1 order by b.id desc");
										if(dbNumRows($jobs) > 0){
