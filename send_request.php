...
if($_REQUEST['action'] == "send_req"){
	...
	if($row['notified'] == "Email" || $row['notified'] == "Both"){
		...
		$mail->Subject = "You are Shortlisted";
		$mail->isHTML(true);
    ...
    <tr>
    <td colspan='2' style='padding-left:10px;'>The employer ".stripslashes($fetch['name'])." has shortlisted you for the job: ".stripslashes($fetch['title']).".</td>
    </tr>
    <tr><td colspan='2'>&nbsp;</td></tr>
    <tr>
    ...
    $smsbody = "The employer ".stripslashes($fetch['name'])." has shortlisted you for the job: ".stripslashes($fetch['title']).".";
