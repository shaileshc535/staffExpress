...
if(count($_POST) > 0 && isset($_POST['paytype']) && isset($_POST['workmode'])){
    ...
    $workmode = isset($_POST['workmode'])?tep_db_input($_POST['workmode']):"";
		...
		echo "<form action='".SITEURL."jobpost3' method='post' id='gotostep2'><input type='hidden' name='jobid' value='".$jobid."'></form><script>document.getElementById('gotostep2').submit();</script>";
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-8 offset-sm-2">
				...
				<form action='<?php echo SITEURL;?>jobpost1' method='post' class="formback">
                    ...
                    <input type="hidden" value="<?php echo trim($_POST['jobid']);?>" name="jobid">
						...
						<div class="form-group">
							...
							<input type="radio" name="paytype" class="" value="3" <?php if($paytype==3) echo "checked";?>> <span>Commission</span> &nbsp; &nbsp;
