	...
	<div class="container">
		...
		<div class="stepbystp">
			<ul>
				...
				<li>Compensation</li>
				<li><img src="<?php echo SITEURL;?>images/dividr.png" alt="" /></li>
				<li class="actv">Additional Details</li>
				<li><img src="<?php echo SITEURL;?>images/dividr.png" alt="" /></li>
		...
		<div class="row">
			...
			<div class="col-sm-8 offset-sm-2">
				...
				<form action='<?php echo SITEURL;?>jobpost2' method='post' class="formback">
                    ...
                    <input type="hidden" value="<?php echo trim($_POST['jobid']);?>" name="jobid">
						...
						<div class="form-group">
							<label>Is There an Application Deadline?</label><br>
								...
								<input type="radio" name="applicn_deadln" value="2" <?php if(!$applicn_deadln || $applicn_deadln == 2) echo "checked";?> > <span>No</span><br>
						</div>
						<?php
